...
echo -e "${BLUE}Создаем файл : $TXT_FILE...${RESET}"
{
  echo "PLK110|97|A"
  echo "CPH2745IN|1B|A"
  echo "CPH2747EEA|44|A"
  echo "CPH2747|A7|A"
  echo "CPH2767IN|1B|A"
  echo "CPH2769EEA|44|A"
  echo "CPH2769|A7|A"
  echo "PLQ110|97|A"
  echo "PLR110|97|A"
  echo "CPH2649IN|1B|F"
  echo "CPH2653EEA|44|F"
  echo "CPH2653|A7|F"
  echo "PJZ110|97|C"
  echo "PKG110|97|C"
  echo "PLC110|97|C"
  echo "CPH2691IN|1B|F"
  echo "CPH2645EEA|44|F"
  echo "CPH2645|A7|F"
  echo "CPH2723IN|1B|C"
  echo "PKX110|97|C"
  echo "CPH2573IN|1B|F"
  echo "CPH2581EEA|44|F"
  echo "CPH2581|A7|F"
  echo "PJD110|97|F"
  echo "PJE110|97|F"
  echo "CPH2585IN|1B|F"
  echo "CPH2609EEA|44|F"
  echo "CPH2609|A7|F"
} > "$TXT_FILE"
...
TXT_DIR="$HOME/"
FN_FILE="$TXT_DIR/phone_name.txt"
...
echo "CPH2745|OnePlus 15" 
echo "CPH2767|OnePlus 15R"
echo "CPH2769|OnePlus 15R"
...
echo "PLQ110|OnePlus Ace 6"
echo "PLR110|OnePlus Ace 6T"
...
chmod +x "$FN_FILE"
echo -e "${GREEN}Файл 'phone_name.txt' успешно создан!${RESET}"
