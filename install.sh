...
echo -e "${BLUE}Создаем файл : $TXT_FILE...${RESET}"
{
  ...
  echo "OnePlus 15 IN|CPH2745IN|1B|A"
  echo "OnePlus 15 EU|CPH2747EEA|44|A"
  echo "OnePlus 15 ROW|CPH2747|A7|A"
  echo "OnePlus Ace6|PLQ110|97|A"
  echo "OnePlus 13 IN|CPH2649IN|1B|F"
  echo "OnePlus 13 EU|CPH2653EEA|44|F"
  echo "OnePlus 13 ROW|CPH2653|A7|F"
  echo "OnePlus 13 CN|PJZ110|97|C"
  echo "OnePlus Ace5|PKG110|97|C"
  echo "OnePlus 13R IN|CPH2691IN|1B|F"
  echo "OnePlus 13R EU|CPH2645EEA|44|F"
  echo "OnePlus 13R ROW|CPH2645|A7|F"
  echo "OnePlus 13s|CPH2723IN|1B|C"
  echo "OnePlus 13T|PKX110|97|C"
  echo "OnePlus 12 IN|CPH2573IN|1B|F"
  echo "OnePlus 12 EU|CPH2581EEA|44|F"
  echo "OnePlus 12 ROW|CPH2581|A7|F"
  echo "OnePlus 12 CN|PJD110|97|F"
  echo "OnePlus Ace3|PJE110|97|F"
  echo "OnePlus 12R IN|CPH2585IN|1B|F"
  echo "OnePlus 12R EU|CPH2609EEA|44|F"
  echo "OnePlus 12R ROW|CPH2609|A7|F"
} > "$TXT_FILE"
...
echo "PLK110|OnePlus 15"
echo "CPH2747|OnePlus 15"
